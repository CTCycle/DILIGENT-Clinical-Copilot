...
- test.automated-regression remains PARTIAL: the focused local diagnostics and Ruff passed. Push-triggered [GitHub Actions run 36015806332](https://github.com/CTCycle/DILIGENT-Clinical-Copilot/actions/runs/36015806332) for commit `6472e9baf1d685ea1790762dd1471910f52416c5` completed successfully: security-scan, backend-quality, windows-regression, and persistence-contract passed; live-provider-e2e was skipped. The dispatch-only live-provider lane and prerequisite-dependent E2E cases remain unrun. Workflow dispatch also requires valid GitHub CLI authentication and the repository secret; the current CLI token is invalid.
