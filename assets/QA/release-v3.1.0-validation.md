...
| Portable package smoke | PASS | `DILIGENT-v3.1.0-windows-x64-portable.exe` passed two launches from the final local rebuild at `b5ebca84`, including a fresh stale readiness marker before each launch; the bundled backends reported PIDs `8068` and `22592`, ports `61647` and `63630`, and `release_version: 3.1.0`. `/api/health`, `/`, and `/clinical-sessions` returned HTTP 200 on both launches; WebView2 loaded the frontend/assets and SQLite startup completed. |
...
| Artifact checksums | PASS | Final local rebuild portable: `0463291e9b654e3b13a635d72d6cda54ec87d274f216ce225e3d5c2dba956b87`; MSI: `b7c05dee06b20dce1a34e3f59542e58b715c572e2d82b33b917ee3947f7b80e4`. |
