...
Date: 2026-08-16
Release candidate: final mainline release preparation after the hosted CFFI preload fix
...
| Portable package smoke | PASS | `DILIGENT-v3.1.0-windows-x64-portable.exe` passed two launches from the final local rebuild at `40e8c68d`, including a fresh stale readiness marker before each launch; the bundled backends reported PIDs `17836` and `29604`, ports `52794` and `56210`, and `release_version: 3.1.0`. `/api/health`, `/`, and `/clinical-sessions` returned HTTP 200 on both launches; WebView2 loaded the frontend/assets and SQLite startup completed. |
...
| Artifact checksums | PASS | Final local rebuild portable: `0c684a370405796e55fbf3f63079d240a1a26e892f91d15697a2340ea3626215`; MSI: `6550ea44c50948ec8b8c93db0e8c1e0da69e1cd70e4e5bd267a066fbc162aaf2`. |
