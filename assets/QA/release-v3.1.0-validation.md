...
| Portable package smoke | PASS | `DILIGENT-v3.1.0-windows-x64-portable.exe` passed two launches from the final local rebuild at `d9706b9d`, including a fresh stale readiness marker before each launch; the bundled backends reported PIDs `32520` and `12256`, ports `56750` and `61576`, and `release_version: 3.1.0`. `/api/health`, `/`, and `/clinical-sessions` returned HTTP 200 on both launches; WebView2 loaded the frontend/assets and SQLite startup completed. |
...
| Artifact checksums | PASS | Final local rebuild portable: `fcf27a3f1e6109dfb16227d6d6bcd20a6bdc3654e0d5974cf8409228211030b3`; MSI: `aa395fe248acaeb6cdbd279185331b73913682352efce2e3c24a0b49e6681b24`. |
