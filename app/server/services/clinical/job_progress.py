...
CLINICAL_PROGRESS_MESSAGES: dict[str, str] = {
    ...
    "rucam.initial": "Step 10/15: Capturing preliminary RUCAM evidence...",
    ...
    "rucam.refined": "Step 13/15: Updating RUCAM evidence with retrieved evidence...",
    ...
    "rucam_estimation": "Step 10/15: Capturing preliminary RUCAM evidence...",
