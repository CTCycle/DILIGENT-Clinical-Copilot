...
echo         Run DILIGENT\start_on_windows.bat first to install the portable runtimes.
exit /b 1
...
if not exist "%project_folder%resources\sources" md "%project_folder%resources\sources" >nul 2>&1
